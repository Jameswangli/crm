...
<body>
	...
	<div class="modal fade" id="exitModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button type="button" class="btn btn-primary" data-dismiss="modal" id="login">确定</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM薛艳薛艳你最棒！！！！！！！！！！！！！！！！！！！！！！！ &nbsp;<span style="font-size: 12px;">&copy;2022 薛艳大宝贝</span></div>
